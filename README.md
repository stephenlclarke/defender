...
initials. Custom attract scripts can draw checked `messages.tsv` labels through
source cursor controls, and the older one-column `high_scores` action remains
available for custom screens.
