...
with no draw, collision bounds, or input actions while hidden, and behavior
scripts can drive the source `HYP2` `LSEED > 0xC0` delayed death-risk branch.
Player hazard collisions now decrement driver-owned life stock and respawn a
