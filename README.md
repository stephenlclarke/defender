...
source-shaped wave-clear survivor-bonus interstitial, next playable wave, and a
bounded reserve activation batch sequence when progression reaches them. The checked
