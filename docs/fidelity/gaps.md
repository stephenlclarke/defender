...
sampled protected-reference `COLTAB` cadence. B13 remains open for remaining
title/Hall of Fame visual drift, scoring sprite/terrain visual drift, candidate
