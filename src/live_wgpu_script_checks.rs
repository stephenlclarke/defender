...
pub(crate) fn run_actor_script_check(path: &Path) -> anyhow::Result<ActorScriptCheckReport> {
    ...
    Ok(ActorScriptCheckReport {
        ...
        first_playing_enemy_bombers: first_playing.enemy_bombers,
        first_playing_enemy_pods: first_playing.enemy_pods,
        first_playing_enemy_mutants: first_playing.enemy_mutants,
        first_playing_enemy_swarmers: first_playing.enemy_swarmers,
