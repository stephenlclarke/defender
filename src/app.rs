...
mod tests {
    ...
    #[test]
    #[ignore = "known DC-18.1 mismatch: missing reference video CRC plus credited-start RNG drift"]
    fn local_reference_start_game_matches_red_label() {
        assert_local_reference_trace_matches("start_game");
    }

    #[test]
    #[ignore = "known DC-18.1 mismatch: missing reference video CRC plus gameplay RNG/object/process drift"]
