...
const ENEMY_BOMB_OUTPUT_ROUTINE_ADDRESS: u16 = 0xE498; // original: SOURCE_BOMB_SHELL_OUTPUT_ROUTINE_ADDRESS
const FIREBALL_OUTPUT_ROUTINE_ADDRESS: u16 = 0xE4D9; // original: SOURCE_FIREBALL_OUTPUT_ROUTINE_ADDRESS
const ENEMY_BOMB_OBJECT_BITMAP_NAME: &str = "BMBP1"; // original: SOURCE_BOMB_SHELL_PICTURE_LABEL
const ENEMY_BOMB_OBJECT_BITMAP_DESCRIPTOR_ADDRESS: u16 = 0xF95B; // original: SOURCE_BOMB_SHELL_PICTURE_ADDRESS
...
const ENEMY_BOMB_OBJECT_BITMAP_SIZE: (u8, u8) = (2, 3); // original: SOURCE_BOMB_SHELL_PICTURE_SIZE
...
const LANDER_ANIMATION_FRAME_COUNT: u8 = 3; // original: SOURCE_LANDER_PICTURE_FRAME_COUNT
