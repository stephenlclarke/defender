...
const ACTOR_SCRIPT_CHECK_PROJECTILE_SAMPLE_STEP_LIMIT: usize = 512;
const ACTOR_SCRIPT_CHECK_RESERVE_ACTIVATION_BATCH_LIMIT: usize = 8;
const ACTOR_SCRIPT_CHECK_ACTOR_SAMPLE_LIMIT: usize = 8;
const ACTOR_SCRIPT_CHECK_PROJECTILE_SAMPLE_LIMIT: usize = 8;
